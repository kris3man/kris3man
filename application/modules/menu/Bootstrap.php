...
class Menu_Bootstrap extends Zend_Application_Module_Bootstrap
{
    ...
    /**
     * Setup shop module, autoloader and resource loader.
     */
    ...
    protected function _initModuleViewHelperPath()
    {
        ...
        $this->_view->addHelperPath(
            APPLICATION_PATH . '/modules/menu/views/helpers',
            'Menu_View_Helper'
        );
    }
    ...
    protected function _initRoutes()
    {
        ...
        $routes = new Zend_Config_Ini(APPLICATION_PATH . '/modules/menu/configs/routes.ini');
